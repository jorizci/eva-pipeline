 ...
 */
package uk.ac.ebi.eva.pipeline.t2d.entity.embedded.id;
...
public class PropertyIdDatasetIdPhenotypeId implements Serializable {
    ...
    public PropertyIdDatasetIdPhenotypeId(DatasetMetadata datasetMetadata, String propertyId, String phenotypeId) {
