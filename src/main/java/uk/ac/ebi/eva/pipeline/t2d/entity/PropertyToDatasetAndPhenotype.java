...
public class PropertyToDatasetAndPhenotype {
    ...
    public PropertyToDatasetAndPhenotype(DatasetMetadata datasetMetadata, String propertyId, String phenotypeId) {
        id = new PropertyIdDatasetIdPhenotypeId(datasetMetadata, propertyId, phenotypeId);
        trustColumn = NULL;
    }
}
